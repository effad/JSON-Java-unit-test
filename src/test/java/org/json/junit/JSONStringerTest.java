...
public class JSONStringerTest {
    ...
    public void simpleObjectString() {
        ...
        assertTrue("expected -23.45e67", new BigDecimal("-23.45e67").equals(jsonObject.query("/doubleValue")));
    }
    ...
    public void simpleArrayString() {
        ...
        assertTrue("expected -23.45e67", new BigDecimal("-23.45e67").equals(jsonArray.query("/5")));
    }
